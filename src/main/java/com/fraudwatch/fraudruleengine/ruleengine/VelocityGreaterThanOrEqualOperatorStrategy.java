...
@Component
public class VelocityGreaterThanOrEqualOperatorStrategy implements OperatorStrategy {

    private final VelocityOperatorStrategy velocityOperatorStrategy;

    public VelocityGreaterThanOrEqualOperatorStrategy(VelocityOperatorStrategy velocityOperatorStrategy) {
