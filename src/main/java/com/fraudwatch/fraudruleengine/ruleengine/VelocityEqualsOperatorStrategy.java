...
@Component
public class VelocityEqualsOperatorStrategy implements OperatorStrategy {

    private final VelocityOperatorStrategy velocityOperatorStrategy;

    public VelocityEqualsOperatorStrategy(VelocityOperatorStrategy velocityOperatorStrategy) {
