...
@Component
public class VelocityGreaterThanOperatorStrategy implements OperatorStrategy {

    private final VelocityOperatorStrategy velocityOperatorStrategy;

    public VelocityGreaterThanOperatorStrategy(VelocityOperatorStrategy velocityOperatorStrategy) {
